    ...
    public static class DataSeeding
    {
        ...
        public static void Seeding(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserAccess>().HasData(
                ...
                new UserAccess { Id = 2, CreatorUserId = AppConsts.SystemUserId, IsActive = true, ParentId = 0, AccessCode = EUserAccess.UserRole, Title = "Access level management", Url = "../Accounting/UserAccess", PageTitle = "Access level management", PageDescription = "Access level management", IsIndirect = true },
